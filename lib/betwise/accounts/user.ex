defmodule Betwise.Accounts.User do
  use Ecto.Schema
  ...
  def registration_changeset(user, attrs, opts \\ []) do
    user
    |> cast(attrs, [:first_name, :last_name, :msisdn, :avatar, :email, :password, :role_id, :custom_permissions])
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Betwise.Repo)
      |> unique_constraint(:email)
    else
      changeset
    end
  ...
  """
  def valid_password?(%Betwise.Accounts.User{hashed_password: hashed_password}, password)
