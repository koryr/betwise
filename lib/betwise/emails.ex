defmodule Betwise.Emails do
  ...
  #   new()
  #   |> to(user.recipient)
  #   |> Swoosh.Email.from({"The Cookie Shop", "hello@cookies.com"})
  #   |> subject("#{user.recipient}, you've made the list")
  #   # |> html_body("<h1>Hello #{user.name}</h1>")
  #   # |> Swoosh.Email.text_body(%{name: user.recipient})
  # end
  ...
  def get_emails() do
    from(s in Betwise.Emails.Email, where: [send: ^false],
    select: s)
    |> Repo.all()
  end
